...
public abstract class Solver(Tile[] tiles, int jokers) : SolverBase(tiles, jokers)
{
    protected Solution TrySet<TS>(IEnumerable<TS> sets, Solution solution, int firstUnusedTileIndex,
    ...
    protected abstract Solution FindSolution(Solution solution, int firstUnusedTileIndex);
